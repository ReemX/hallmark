...
```bash
INIT=$(node "C:/Users/reema/Documents/Programming/achievements/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/reema/Documents/Programming/achievements/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
