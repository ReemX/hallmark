...
```
Agent(
  prompt="Read C:/Users/reema/Documents/Programming/achievements/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/reema/Documents/Programming/achievements/.claude/get-shit-done/templates/VALIDATION.md`
