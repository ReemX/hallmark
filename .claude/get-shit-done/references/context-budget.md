...
The keys live in `.claude/settings.json` (project) or `C:/Users/reema/Documents/Programming/achievements/.claude/settings.json` (global) — **not** in `.planning/config.json`:
